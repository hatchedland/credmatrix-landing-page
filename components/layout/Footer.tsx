...
export default function Footer() {
  ...
  return (
    <>
      <footer className="bg-secondary text-white py-48">
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-48">
            {/* Logo and Description */}
            <div>
              <Link href="/" className="flex items-center gap-8 mb-24">
            ...
            {/* Quick Links */}
            <div>
              <h3 className="text-lg font-semibold mb-24">Quick Links</h3>
            ...
            {/* Contact Form */}
            <div className="bg-secondary-light rounded-xl p-24">
              <h3 className="text-lg font-semibold mb-16">Have Questions?</h3>
              <p className="text-sm text-neutral-300 mb-24">
              ...
              <div className="flex gap-12">
                ...
                >
                  Get Started
                  <ArrowRight className="w-16 h-16 ml-4" />
                </Button>
              </div>
            </div>
          </div>
          ...
          {/* Copyright */}
          <div className="mt-48 pt-24 border-t border-neutral-700 text-center text-sm text-neutral-400">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-16">
          <div className="bg-white rounded-xl p-32 max-w-md w-full relative">
            <button
              onClick={() => setShowModal(false)}
              className="absolute top-16 right-16 text-neutral-400 hover:text-neutral-600"
            >
              <svg className="w-24 h-24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
              </svg>
            </button>
            <h3 className="text-2xl font-semibold text-secondary mb-24">
              Get Started Today
            </h3>
